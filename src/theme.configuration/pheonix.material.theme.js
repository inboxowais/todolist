...
import { themeProps } from './pheonix.material.theme.props';
import { themeStyles } from './pheonix.material.theme.style'
import { materialThemeBase } from './pheonix.material.theme.base';

export const jubileeTheme = createMuiTheme({
  ...materialThemeBase,
  props: {
    ...themeProps
  },
